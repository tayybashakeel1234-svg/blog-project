...
// import "./components/CreateArticle.css";
...
import { useEffect, useState } from "react";
import "./components/CreateArticle.css"; // Make sure this CSS file has your form styles
          ...
          <form
            ...
            onSubmit={async (e) => {
              ...
              try {
                ...
                setBlogs([savedBlog, ...blogs]); // update list
